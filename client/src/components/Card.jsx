...
const Card = () => {
  return (
    <div className='flex flex-col md:flex-row text-white overflow-hidden mx-auto justify-center items-center bg-sky-300 rounded h-min-screen md:h-[320px] w-[360px] p-4'>
      <div className='flex flex-col items-center md:items-start md:flex-1'>
        ...
        <button className='bg-green-400 rounded px-4 py-1.5 mt-4 hover:bg-green-600'>View Profile</button>
      </div>
