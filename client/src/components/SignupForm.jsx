            ...
            <form className='max-w-lg'   onSubmit={submitHandler}>
                <div className='text-white'>
                    <label className='font-semibold h-full'>
                        ...
                        <input className='bg-teal-800 rounded text-cyan-400 px-[12px] py-2 max-w-120 w-full'
                            required
                            type='text'
                            name='fullname'
                ...
                <div className='text-white'>
                    <label className='font-semibold h-full'>
                        ...
                        <div className='relative'>
                            <input className='bg-teal-800 rounded text-cyan-400 px-[12px] py-2 w-full pr-10'
                                required
